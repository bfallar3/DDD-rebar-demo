...
namespace People.ServiceHost.IIS
{
    public class Global : System.Web.HttpApplication
    {
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            People.Host.IIS.App_Start.TracingConfig.Register(config);
            ...
            GlobalConfiguration.Configure(p => People.Service.Config.PeopleServiceRouteConfig.RegisterRoutes(config, perRouteServiceHandlers));
